...
import discordgamesdk.IDiscordCore.ByReference;
...
public interface DiscordGameSDKLibrary extends Library {
	...
	public static final NativeLibrary JNA_NATIVE_LIB = NativeLibrary.getInstance(DiscordGameSDKLibrary.JNA_LIBRARY_NAME);
